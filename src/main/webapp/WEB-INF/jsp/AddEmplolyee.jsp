        ...
        <form:form action="/saveEmployee" method="post" modelAttribute="employee">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            			<form:input type="text" path="eMail" id="date"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="date">Phone</label>
            		<div class="col-md-6">
            			<form:input type="text" path="ePhone" id="date"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="date">Salery</label>
            		<div class="col-md-6">
            			<form:input type="text" path="eSalary" id="date"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="date">Manager</label>
            		<div class="col-md-6">
            			<form:input type="text" path="eManager" id="date"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
